...
//    @Test
//    public void implementMineInterface() throws Exception {
//        copyFileFromResources("ru/spbu/MineInterface.class");
//        checkInterfaceImplementationFromFolder("ru.spbu.MineInterface");
//    }
    ...
    private void copyFileFromResources(String fileName) {
        ClassLoader classLoader = this.getClass().getClassLoader();
        File dest = new File(getTestsDirectoryPath() + "/" + fileName);
        try {
